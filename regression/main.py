...
# SHOT algorithm
parser.add_argument('--SHOT', action="store_true", help="whether to use SHOT",)
parser.add_argument('--SHOT-lr', type=float, default=0.1, help="step size for the one-step update",)
